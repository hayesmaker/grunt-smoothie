var expect = require('chai').expect,
	sinon = require('sinon'),
	MyNodeClass = require('../../tmp/MyNodeClass');

describe("MyClassModule tests", function() {
	...
	beforeEach(function() {
		...
		initSpy = sinon.spy(MyNodeClass.prototype, 'init');
		logSpy = sinon.spy(console, 'log');

		myClass = new MyNodeClass();
	});

	afterEach(function() {

		MyNodeClass.prototype.init.restore();
		console.log.restore();
